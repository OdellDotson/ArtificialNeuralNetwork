# Odell "Vorpal Bunny" Dotson && Ethan "The Floorboards of Heaven" Prihar as initial developers.
# Odell Dotson as current developer.
...
def backProp():
    ...
    #Removed because classification isn't something I care about very much.
    """
